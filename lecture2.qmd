...
## Bottleneck {background-image="images/bottleneck.png" background-size="contain" background-opacity=".2"}

![](images/responses/bottleneckClarity.png)
I've updated the textbook with an additional paragraph on this.
...
Read [Chapter 4](https://psyc2016.whatanimalssee.com/overtCovert.html) and then give me a more specific question.
...
-   Vigilance <!-- only very briefly in Ch. 5, 16-->
