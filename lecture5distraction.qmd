...
-   Also: Drives social interaction by stoking outrage around the news.
...
-   Most times you open an app, you get one of these many interesting things

Some of the cognitive is habits created by rewards [Chapter 16](https://psyc2016.whatanimalssee.com/distraction1.html)

## Ultimate is videogames {background-image="images/threeWiseMonkeys/640.jpg" background-opacity="0.05"}
...
::: notes :::
Think about how little time you spend on each post
:::
...
-   When we find something rewarding/worthwhile, we **exploit** that opportunity
-   Vigilance isn't the only reason we attend to events that aren't part of our current task
-   Exploration is a drive
    -   The *yin* to exploitation's *yang*
-   The "explore/exploit trade-off"

::: notes :::
Many animals, including us, have a drive to explore the world.
:::
...
## Are you not going to do it because it's not cool? {background-image="images/threeWiseMonkeys/640.jpg" background-opacity="0.05"}
