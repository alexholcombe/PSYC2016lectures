...
<!-- In 2026 they loved this lecture, I was worried it would be too short but it wasn't because they asked so many questions, including about:
- dating , whether explore/exploit applies to that
- something that led me to talk about optimal foraging theory and how our primate ancestors had to decide when to move on to the next food source
- choice overload

- Only thing I would add is the baby chimp in Rwanda playing, discovering/exploring how it can move its body (don't forget to like and subscribe!)
-->
...
<!-- Give this as reading 
Since you're teaching, I think this is a neat real-world example of explore-exploit https://tomstafford.substack.com/p/striking-evidence-for-forced-experimentation
-->
...
<!--
I changed the x-axis label because I thought it was wrong, but then Tom explaiend that the issue is that even though the vertical axis is labelled performance, higher is worse! But that's too hard for the students to keep straight so I'll stick with this.
