...
::: {.nonincremental}
-   Top-down vs. bottom-up attention (AKA endogenous vs exogenous)
-   Location selection
-   Feature selection
...
## <!--bottleneck student question -->

![](images/responses/isBottleneckSuitableAnalogy.png)

- Unlike highway bottlenecks, pre-bottleneck stimuli constantly being replaced

- That's how the two-letter experiment worked, new letters were rapidly coming in and replaced the ones that were previously pre-bottleneck
...
ForceQuitQuestion2026.png

lect2ch5oneOfTheMainPoints.png

lect2AnsToQuestions.png

## What distracted you?

DistractedYouReading6groups2026.png
