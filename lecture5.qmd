...
## Capacity is very limited for some things {background-image="images/conjunctionRedRight.png" background-opacity=".5" }

- Letters (that don't make a word) or words
- Other feature combinations
  
## {background-image="images/wheresWallyBeach.jpg" background-opacity=".5"}

Limited capacity is *part* of the difficulty in finding Wally

![](images/Wally.webp)

::: notes
But another part is that peripheral vision is crap. 
:::
...
## Linking back to vigilance {background-image="images/wallabyCampsitePittwater.JPG" background-opacity=".3"}
...
## Inattentional blindness {background-image="images/gorillaVideoSnapshotNoGorilla.png" }
