...
## Capacity is very limited for some things {background-image="images/bottleneck.png" background-size="contain" background-opacity=".2"}
...
## CHANGE BLINDNESS - [Ch. 6](https://psyc2016.whatanimalssee.com/twoPicChangeBlindness.html) {background-image="images/NedBlock.webp" background-opacity=".2"}
