...
Understand how unscientific attention comments relate to scientific concepts (Ch.1)
:::
...
::: {.callout-note appearance="simple" icon="false"}
Understand how unscientific ways of talking about attention relate to scientific concepts (Ch.1)
:::
...
## {background-image="images/multicore/multicoreBgRemovedCanva.png" background-opacity="0.2" background-size="600px"}
...
## You didn't get both letters right? {background-image="images/bottleneckPerceptionCognition.png" background-opacity=".3"}
...
## Bottleneck - for letter identification {background-image="images/bottleneckPerceptionCognition.png" background-opacity=".3"}
...
::: notes
Do I have more time as a result of not having to do the in-lecture quiz? Definitely do soemthing interactive
:::
